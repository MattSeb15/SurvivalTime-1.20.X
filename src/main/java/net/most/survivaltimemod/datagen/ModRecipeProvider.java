...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        for (Map.Entry<ItemLike, ExpCookTimeGroupItem> entry : SurvivalTimeUtilGenerator.SMELTING_MAP.entrySet()) {
        ...
        for (Map.Entry<ItemLike, ExpCookTimeGroupItem> entry : SurvivalTimeUtilGenerator.BLASTING_MAP.entrySet()) {
            ItemLike item = entry.getKey();
            ExpCookTimeGroupItem expCookTimeGroup = entry.getValue();
            oreBlasting(pWriter,
                    item,
        ...
        for (Map.Entry<ItemLike, ItemLike> entry : SurvivalTimeUtilGenerator.BLOCK_FROM_ITEM_MAP.entrySet()) {
...
//        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.FIERY_TIME_BLOCK.get())
//                .pattern("###")
//                .pattern("###")
//                .pattern("###")
//                .define('#', ModItems.FIERY_TIME.get())
...
//        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.FIERY_TIME.get(), 9)
//                .requires(ModItems.FIERY_TIME.get())
//                .unlockedBy(getHasName(ModItems.OPAL_SHARD_EPOCH.get()), has(ModItems.OPAL_SHARD_EPOCH.get()))
//                .save(pWriter);
